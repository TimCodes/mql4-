...
int start()
  {
      ...
      DonchianTopEntry1    = iCustom(NULL, 0, "DonChianChannel", MaxBars, 1,1);
      DonchianBottomEntry1 = iCustom(NULL, 0, "DonChianChannel", MaxBars, 0,1);
      
      DonchianTopExit1     = iCustom(NULL, 0, "DonChianChannel", MaxBars, 1,1);
      DonchianBottomExit1  = iCustom(NULL, 0, "DonChianChannel", MaxBars, 0,1);
      ...
      if(CountPosOrders(MagicNumber, OP_BUY) >= 1 && ExitSignal(LongEntryBreakout) == 1 ){ // Close Long Positions
      ...
      if(IsMaxPositionsReached(MaxPositionsAllowed, MagicNumber, OnJournaling) == False){
         ...
         if(!entryLock && EntrySignal(LongEntryBreakout) == 1 ){
         ...
         }else if(!entryLock && EntrySignal(ShortEntryBreakout) == 2){
     ...
     if( HasPositionsDecreased(MagicNumber) ){
